...
export function MarketPanel() {
  ...
  return (
    <div className="flex flex-col gap-0 relative" style={{
      ...
      borderRadius: 2,
      boxShadow: '0 0 40px rgba(201,162,39,0.15), inset 0 0 60px rgba(0,0,0,0.4)',
    }}>
      {/* top fire accent line */}
      <div style={{ position: 'absolute', top: 0, left: 0, right: 0, height: 2, background: 'linear-gradient(90deg, transparent, #C9A227AA, #E2C54788, transparent)', borderRadius: '2px 2px 0 0' }} />

      <div className="flex flex-col gap-4 p-4 pt-5">
        <h2 style={{ fontFamily: "'Inter', sans-serif", color: '#E2C547', fontSize: 13, fontWeight: 700, letterSpacing: 2, textShadow: '0 0 20px rgba(201,162,39,0.6)' }}>
          Who will survive?
        </h2>
